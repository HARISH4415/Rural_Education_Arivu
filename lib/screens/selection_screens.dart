...
class SubjectSelectionScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final subjects = SyllabusModel.getSubjects(standard, mode);
    final responsive = Responsive(context);
  ...
  Map<String, dynamic> _getSubjectTheme(String subject) {
    switch (subject) {
      ...
      case 'History':
        return {'icon': Icons.history_edu_rounded, 'color': Colors.brown[400]};
      case 'Geography':
        return {'icon': Icons.public_rounded, 'color': Colors.green[600]};
      case 'Social':
  ...
  Widget _buildBookLibrary(BuildContext context) {
    ...
    String getBookUrl(int std, String sub, int term) {
      switch (std) {
        case 1:
          if (sub == 'Tamil' && term == 1)
            return 'https://drive.google.com/file/d/1ERNitenUWgTdwRFDsjvW3HR7X8pBPcNX/view?usp=drive_link';
          if (sub == 'English' && term == 1)
            return 'https://drive.google.com/file/d/1SNbWOYuEFFo5ieVppQoBImY-U7SSDFb9/view?usp=drive_link'; // Add Class 1 English Term 1
          if (sub == 'Maths' && term == 1)
            return 'https://drive.google.com/file/d/1R2WhGki-aLix8EB-AzLhwk_ZYKCZK5Yo/view?usp=drive_link'; // Add Class 1 Maths Term 1
          if (sub == 'EVS' && term == 1)
            return 'https://drive.google.com/file/d/1WKaVbzCihDAKZYppmmeG6h42daXx6HIJ/view?usp=drive_link'; // Add Class 1 EVS Term 1
          // Term 2
          if (sub == 'Tamil' && term == 2)
            return 'https://drive.google.com/file/d/1V1Vh6rwNcaPT7ST8H512UHDNG_ciQXgb/view?usp=drive_link';
          if (sub == 'English' && term == 2)
            return 'https://drive.google.com/file/d/1Li4vTlHcAzuI5KveD3O_BkVKaZnI7hFV/view?usp=drive_link';
          if (sub == 'Maths' && term == 2)
            return 'https://drive.google.com/file/d/1Arekvf48RlygWvGeyGv-UOoKM3s-YY0G/view?usp=drive_link';
          if (sub == 'EVS' && term == 2)
            return 'https://drive.google.com/file/d/1dyUbLLT7MxTcnaicW0LM1p4RXQSALTTQ/view?usp=drive_link';
          return '';

        case 2:
          // --- CLASS 2 LINKS ---
          if (sub == 'Tamil' && term == 1)
            return 'https://drive.google.com/file/d/1aLd7hNOTDPA9QexmdVxj-_RqfZ52nUcX/view?usp=drive_link'; // Paste Class 2 Tamil Link
          if (sub == 'English' && term == 1)
            return 'https://drive.google.com/file/d/1yOTzQ58H9oKu8f5OBEmST14CLLb9_br7/view?usp=drive_link'; // Paste Class 2 English Link
          if (sub == 'Maths' && term == 1)
            return 'https://drive.google.com/file/d/1FAsP1etaibCErcwupE1niB0xOJR0VyeY/view?usp=drive_link'; // Paste Class 2 Maths Link
          if (sub == 'EVS' && term == 1)
            return 'https://drive.google.com/file/d/1eHBT7lq9E45ZD74oQA6C7T95ZMFmKaNw/view?usp=drive_link'; // Paste Class 2 EVS Link
          // Term 2
          if (sub == 'Tamil' && term == 2)
            return 'https://drive.google.com/file/d/1vtp3iyzxVjIlat5CTjZwUkHLel8wqvBl/view?usp=drive_link'; // Paste Class 2 Tamil Link
          if (sub == 'English' && term == 2)
            return 'https://drive.google.com/file/d/1TIQ0MZrsQNyb9ao9aD4UQM7Cd4o9jlR9/view?usp=drive_link'; // Paste Class 2 English Link
          if (sub == 'Maths' && term == 2)
            return 'https://drive.google.com/file/d/1_5tAsPd38oVN3t8Ddb43daxvDJO1cWLk/view?usp=drive_link'; // Paste Class 2 Maths Link
          if (sub == 'EVS' && term == 2)
            return 'https://drive.google.com/file/d/1PQxnGlVdmAO_O3cQ89trijo9ikbb1yR3/view?usp=drive_link'; // Paste Class 2 EVS Link
          return '';

        case 3:
          // --- CLASS 3 LINKS ---
          if (sub == 'Tamil' && term == 1)
            return 'https://drive.google.com/file/d/1DDhrHyQT0fu67LE-OcNYWzSsjMDJYf3C/view?usp=drive_link'; // Paste Class 3 Tamil Link
          if (sub == 'English' && term == 1)
            return 'https://drive.google.com/file/d/12OPweaV50G-FQp32TiXl2G7JHroeWplU/view?usp=drive_link'; // Paste Class 3 English Link
          if (sub == 'Maths' && term == 1)
            return 'https://drive.google.com/file/d/1CeXXpWiwdvnAJQFJZSoNMUj5XzzWe_ni/view?usp=drive_link'; // Paste Class 3 Maths Link
          if (sub == 'Science' && term == 1)
            return 'https://drive.google.com/file/d/1AwgC1youLN9XKNL_yUon1DiM5MWscbH4/view?usp=drive_link'; // Paste Class 3 Science Link
          if (sub == 'Social' && term == 1)
            return 'https://drive.google.com/file/d/1ha2g_CmamSkO8cFArcvh1T078cW9FetE/view?usp=drive_link'; // Paste Class 3 Social Link
          //Term 2
          if (sub == 'Tamil' && term == 2)
            return 'https://drive.google.com/file/d/17Ncll_5bdaKiHxps6OPNyPeKidE9lMx4/view?usp=drive_link'; // Paste Class 3 Tamil Link
          if (sub == 'English' && term == 2)
            return 'https://drive.google.com/file/d/17Ncll_5bdaKiHxps6OPNyPeKidE9lMx4/view?usp=drive_link'; // Paste Class 3 English Link
          if (sub == 'Maths' && term == 2)
            return 'https://drive.google.com/file/d/10bFkKhkAYcQkDUu-0Bqm7bHZjHmz8Cel/view?usp=drive_link'; // Paste Class 3 Maths Link
          if (sub == 'Science' && term == 2)
            return 'https://drive.google.com/file/d/1WuCVO-gHHKCKutgwogkMs_k9MQJM_0L9/view?usp=drive_link'; // Paste Class 3 Science Link
          if (sub == 'Social' && term == 2)
            return 'https://drive.google.com/file/d/1pUH_I8rtsv3WMPXVRRSgsLMHay4GdinM/view?usp=drive_link'; // Paste Class 3 Social Link
          return '';

        case 4:
          // --- CLASS 4 LINKS ---
          if (sub == 'Tamil' && term == 1)
            return 'https://drive.google.com/file/d/1rorKQCX7vnxPiTkVbq3nSZMEP2KC_emW/view?usp=drive_link';
          if (sub == 'English' && term == 1)
            return 'https://drive.google.com/file/d/1ezUip0D_IkTeQHAulAXloZ2EEca3SSy-/view?usp=drive_link';
          if (sub == 'Maths' && term == 1)
            return 'https://drive.google.com/file/d/1sS43QaJnUwXPy1SgU-wrjSuL3uVAJzz8/view?usp=drive_link';
          if (sub == 'Science' && term == 1)
            return 'https://drive.google.com/file/d/15utpa2jgmfb5fOHR7307FVIrQriFOQpG/view?usp=drive_link';
          if (sub == 'Social' && term == 1)
            return 'https://drive.google.com/file/d/18gfhOBhrWpMMq6lQAh3MKtfUSHpwChHN/view?usp=drive_link';
          // Term2
          if (sub == 'Tamil' && term == 2)
            return 'https://drive.google.com/file/d/1J-FiiTwoufnvhSnChW_CCn0petVfW9Ar/view?usp=drive_link';
          if (sub == 'English' && term == 2)
            return 'https://drive.google.com/file/d/1NUVVdS4jUWYJFQ6t9QGrnOcab5kg_YpT/view?usp=drive_link';
          if (sub == 'Maths' && term == 2)
            return 'https://drive.google.com/file/d/1I5wb20YB0h9WQU0fCaxaTY1NqJeO3Y2d/view?usp=drive_link';
          if (sub == 'Science' && term == 2)
            return 'https://drive.google.com/file/d/1mBnGbSz9rS7hAG0LhFfwnuL6-VsMdW9m/view?usp=drive_link';
          if (sub == 'Social' && term == 2)
            return 'https://drive.google.com/file/d/1rgQE40PBRymwfsVjf8y8Os0vN-M1hq3e/view?usp=drive_link';
        ...
        case 5:
          // --- CLASS 5 LINKS ---
          if (sub == 'Tamil' && term == 1)
            return 'https://drive.google.com/file/d/1YGg1pZM7kvpMYW5mqruG2w-DSh7Dx5TL/view?usp=drive_link';
          if (sub == 'English' && term == 1)
            return 'https://drive.google.com/file/d/104tZKRjmnCSA4kDXw6g8P8b3zXUbry6v/view?usp=drive_link';
          if (sub == 'Maths' && term == 1)
            return 'https://drive.google.com/file/d/1RCWHReoV-BSPL5_jmb-LP0_3rd5TXuYk/view?usp=drive_link';
          if (sub == 'Science' && term == 1)
            return 'https://drive.google.com/file/d/1Jt93APTf9eNMxjfVYAyW1yUpX6z_Mia8/view?usp=drive_link';
          if (sub == 'Social' && term == 1)
            return 'https://drive.google.com/file/d/1w-nvLHeFFP1UuhuiYI2GteuW7hHHH5Du/view?usp=drive_link';
          //Term 2
          if (sub == 'Tamil' && term == 2)
            return 'https://drive.google.com/file/d/1cQnWnZicr8Qh-Z_zUL6JDYMHu9IeznER/view?usp=drive_link';
          if (sub == 'English' && term == 2)
            return 'https://drive.google.com/file/d/1fdI4o_fRMf0BWBLD4sFkhgpcuv4_yRry/view?usp=drive_link';
          if (sub == 'Maths' && term == 2)
            return 'https://drive.google.com/file/d/15aYkc080bO5egO3ogf_JfLlPlpMpdwZD/view?usp=drive_link';
          if (sub == 'Science' && term == 2)
